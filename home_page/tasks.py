    ...
    <html>
        <body>
            ...
            <p>
                ...
                συνδρομής σας στον <strong>Σύνδεσμο Γονέων και Φίλων Καρδιοπαθών Παιδιών.</strong><br> 
                ...
                στις οικογένειές τους, προσφέροντας βοήθεια, στήριξη και ελπίδα.<br>Αν έχετε 
